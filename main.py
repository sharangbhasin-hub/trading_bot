...
def render_index_options_tab():
    ...
    if 'options_chain' in st.session_state:
        ...
        with tab3:
            ...
            st.caption("*This consensus is calculated from all indicators analyzed above*")
                    ...
                    with st.expander("📈 Intraday Trade Analysis - Strategy Signals", expanded=True):
                        ...
                        if should_analyze:
                            ...
                            try:
                                ...
                                support_15min, resistance_15min = calculate_dynamic_support_resistance(mtf_data['daydata'])
                                ...
                                **Reasoning:** Both daily trend and intraday signals are aligned.  
                                This is a high-confidence setup.
                                        ...
                                        print("⚠️ No strategy signals detected - stored empty state")
